...
public class Page6Activity extends AppCompatActivity {
    ...
    private void setupClickListeners() {
        ...
        findViewById(R.id.casablanca1Layout).setOnClickListener(v -> navigateToPage7("Casablanca"));
        findViewById(R.id.Fes1Layout).setOnClickListener(v -> navigateToPage7("Fes"));
        findViewById(R.id.Sale1Layout).setOnClickListener(v -> navigateToPage7("Sale"));
        findViewById(R.id.Tanger1Layout).setOnClickListener(v -> navigateToPage7("Tanger"));
    ...
    private void navigateToPage7(String ville) {
        try {
