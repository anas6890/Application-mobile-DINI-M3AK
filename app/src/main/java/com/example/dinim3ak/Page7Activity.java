...
public class Page7Activity extends AppCompatActivity {
    ...
    private String villeDepartReceived; // Ville reçue de Page6
    ...
    private void setupClickListeners() {
        ...
        findViewById(R.id.rabatLayout).setOnClickListener(v -> navigateToPage8("Rabat"));
        findViewById(R.id.Fes2Layout).setOnClickListener(v -> navigateToPage8("Fes"));
        findViewById(R.id.Sale2Layout).setOnClickListener(v -> navigateToPage8("Sale"));
        findViewById(R.id.Tanger2Layout).setOnClickListener(v -> navigateToPage8("Tanger"));
    ...
    private void navigateToPage8(String villeDestination) {
        try {
